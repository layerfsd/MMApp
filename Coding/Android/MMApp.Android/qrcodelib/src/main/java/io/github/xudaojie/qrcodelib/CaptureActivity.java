...
import io.github.xudaojie.qrcodelib.common.QRCodeDecoder;
...
//            flashIbtn.setText(getResources().getString(R.string.close_flashlight));
//        }
...
//        }
    ...
    protected void initView() {
        ...
        flashIbtn = (TextView) findViewById(R.id.flash_ibtn);
    ...
    public void toggleFlashLight() {
        if (CameraManager.get().isFlashLightOpen()) {
            ...
            flashIbtn.setText(getResources().getString(R.string.open_flashlight));
        } else {
     ...
     * @param open
     */
    public void setFlashLightOpen(final boolean open) {
        if (CameraManager.get().isFlashLightOpen() == open) return;
...
//    }
    ...
    private final OnCompletionListener beepListener = new OnCompletionListener() {
     ...
     protected abstract void showDecodeImage();
    ...
    private void decode(Bitmap bitmap, final String err) {
        QRCodeDecoder.decodeQRCode(bitmap, new QRCodeDecoder.Delegate() {
            ...
            @Override
            public void onDecodeQRCodeFailure(String error) {
                handleResult(error);
            }
        });
    }
