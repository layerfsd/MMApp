...
<template>
    <div class="change-initial-pin layout">
        ...
        <div class="input-wrapper">
            <password-control class="input-padding" name="changeInitialPIN" @getChange="compare" ref="passwordControl" :count="4"></password-control>
        </div>
        <div class="input-wrapper" style="margin-top: 20px">
            <password-control class="input-padding" name="changeInitialPIN" @getChange="compare2" ref="passwordControl" :count="4"></password-control>
        </div>
        <div class="tips">
